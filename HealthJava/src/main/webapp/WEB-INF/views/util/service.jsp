...
<head>
<meta charset="UTF-8">
<title>HealthJava 서비스 이용약관</title>
...
<div class="wrap">
	<div class="service_content">
        ...
        <div class="service_body">
			제1조(목적)<br>
			이 약관은 (주)헬스자바(전자거래 사업자, 이하 "회사"라 함)가 운영하는 사이버 몰에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
			...
			⑤ "헬스자바TV"이라 함은 몰에서 제공하는 반려동물 영상 콘텐츠를 말합니다.<br>
			⑥ "헬스자바 LOG"이라 함은 몰에서 제공하는 커뮤니티를 말합니다<br>
			...
			7. 위치정보(회원이 헬스자바LOG에 사진 업로드하는 경우)<br>
			...
			⑥ "몰"은 이용자가 "몰"이 승인하지 않은 방법 또는 허위 정보 제공, 본 약관에 위배되는 등의 부정한 방법으로 적립금이나 스탬프를 사용하는 경우 헬스자바 적립금과 스탬프의 사용을 제한 또는 "몰"이 정한 방법으로 회수할 수 있으며, 적립금이나 스탬프를 사용한 구매신청을 취소하거나 이용자 자격을 정지할 수 있습니다.<br>
